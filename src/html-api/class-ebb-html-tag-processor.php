<?php
/**
 * HTML API: EBB_HTML_Tag_Processor class
 *
 ...
 * Example:
 *
 *     $tags = new EBB_HTML_Tag_Processor( $html );
 ...
 * Example:
 *
 *     $processor = new EBB_HTML_Tag_Processor( 'This <div is="a" partial="token' );
 ...
 * Example:
 *
 *     $processor = new EBB_HTML_Tag_Processor( '<style>// there could be more styling to come' );
 *     false === $processor->next_tag();
 *
 *     $processor = new EBB_HTML_Tag_Processor( '<style>// this is everything</style><div>' );
...
class EBB_HTML_Tag_Processor {
	 ...
	 * @var int
	 *
	 * @see EBB_HTML_Tag_Processor::set_bookmark()
	 */
	 ...
	 * @var int
	 *
	 * @see EBB_HTML_Tag_Processor::seek()
	 */
	 ...
	 * @since 6.5.0
	 *
	 * @see EBB_HTML_Tag_Processor::STATE_READY
	 * @see EBB_HTML_Tag_Processor::STATE_COMPLETE
	 * @see EBB_HTML_Tag_Processor::STATE_INCOMPLETE_INPUT
	 * @see EBB_HTML_Tag_Processor::STATE_MATCHED_TAG
	 * @see EBB_HTML_Tag_Processor::STATE_TEXT_NODE
	 * @see EBB_HTML_Tag_Processor::STATE_CDATA_NODE
	 * @see EBB_HTML_Tag_Processor::STATE_COMMENT
	 * @see EBB_HTML_Tag_Processor::STATE_DOCTYPE
	 * @see EBB_HTML_Tag_Processor::STATE_PRESUMPTUOUS_TAG
	 * @see EBB_HTML_Tag_Processor::STATE_FUNKY_COMMENT
	 *
	 * @var string
	 */
	 ...
	 *         'wp-block-group' => EBB_HTML_Tag_Processor::ADD_CLASS,
	 *         'wp-group'       => EBB_HTML_Tag_Processor::REMOVE_CLASS
	 *     );
	 *
	 * @since 6.2.0
	 * @var bool[]
	 ...
	 * Example:
	 *
	 *     $processor = new EBB_HTML_Tag_Processor( '<input type="text" value="Th' );
	 ...
	 * Example:
	 *
	 *     $p = new EBB_HTML_Tag_Processor( "<div class='free &lt;egg&lt;\tlang-en'>" );
	 *     $p->next_tag();
	 ...
	 * @since 6.2.0
	 *
	 * @see EBB_HTML_Tag_Processor::$lexical_updates
	 * @see EBB_HTML_Tag_Processor::$classname_updates
	 */
	 ...
	 * Example:
	 *
	 *     $p = new EBB_HTML_Tag_Processor( '<div enabled class="test" data-test-id="14">Test</div>' );
	 ...
	 * Example:
	 *
	 *     $p = new EBB_HTML_Tag_Processor( '<div class="test">Test</div>' );
	 *     $p->next_tag() === true;
	 *     $p->get_tag() === 'DIV';
	 *
	 *     $p->next_tag() === false;
	 ...
	 * Example:
	 *
	 *     $p = new EBB_HTML_Tag_Processor( '<div></div>' );
	 ...
	 * Example:
	 *
	 *     $processor = new EBB_HTML_Tag_Processor( "\x00Apples & Oranges" );
	 ...
	 *
	 *     $processor = new EBB_HTML_Tag_Processor( "&#x13; \r\n\tMore" );
	 ...
	 * @since 6.2.0
	 *
	 * @see EBB_HTML_Tag_Processor::get_updated_html()
	 *
